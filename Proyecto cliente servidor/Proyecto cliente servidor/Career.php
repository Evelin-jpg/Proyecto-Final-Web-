...
echo '
            <tr>           
                ...
                <td><a href="FormUpdCareer.php?CareerID='.$registro["CareerID"].'"><i class="bi bi-pencil-square"></i>
                <td><a href="DelCareer.php?CareerID='.$registro["CareerID"].'" onclick="return confirm(\'¿Estás seguro de que deseas eliminar este registro?\')">
